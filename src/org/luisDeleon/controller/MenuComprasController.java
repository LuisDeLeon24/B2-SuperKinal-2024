...
import org.luisDeleon.model.Compra;
import org.luisDeleon.model.Producto;
import org.luisDeleon.system.Main;
import org.luisDeleon.model.DetalleCompra;
    ...
    public void handleButtonAction(ActionEvent event){
        if(event.getSource() == btnGuardar){
            ...
            if(tfBuscarCompra.getText().equals("")){
                ...
                colCantidad.setCellValueFactory(new PropertyValueFactory<DetalleCompra, String>("cantidadCompra"));
            }
        }
    }
     ...
     public DetalleCompra buscarCompra(){
        ...
        try{
            ...
            if(resultSet.next()){
                ...
                detalleCompra = (new DetalleCompra(compraId,fecha,total,cantidad,producto ));
            }
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }finally{
