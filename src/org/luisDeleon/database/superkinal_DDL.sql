...
VALUES
    ('Turbina de Sueños', 'Genera sueños felices durante el sueño.', 100, 10.99, 9.99, 5.99, 1, 1),
    ('Luz de Luna en Frasco', 'Ilumina las noches oscuras con su luz tenue y reconfortante.', 150, 15.99, 12.99, 8.99, 2, 1),
    ('Esencia de Bosque Encantado', 'Una fragancia mágica que te transporta a un bosque de ensueño.', 200, 20.99, 17.99, 13.99, 1, 2),
    ('Manto Estelar de Noches', 'Cubre tu cama con un manto de estrellas para dormir bajo el cielo.', 120, 12.99, 10.99, 7.99, 3, 2),
    ('Poción de Risas Infinitas', 'Una poción mágica que desata carcajadas sin fin.', 180, 18.99, 15.99, 11.99, 2, 3),
    ('Escudo de Protección Solar', 'Protege tu piel de los rayos del sol con este escudo invisible.', 220, 22.99, 19.99, 17.99, 1, 3),
    ('Pluma de Inspiración Creativa', 'Una pluma que desata la creatividad en cada trazo.', 90, 9.99, 7.99, 4.99, 3, 1),
    ('Espejo de Reflexión Positiva', 'Refleja la belleza interior y potencia la confianza en ti mismo.', 130, 13.99, 11.99, 9.99, 2, 2),
